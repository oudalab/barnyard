...
CREATE TABLE `reproduction` (
  ...
  `pasturenumber` bigint(10) DEFAULT NULL,
  ...
  `hiphtweaning` float DEFAULT NULL,
  `hiphtbreeding` float DEFAULT NULL,
  ...
  KEY `fk_AID_2_idx` (`Animal_id`),
  KEY `fk_pasturenumber_idx` (`pasturenumber`),
  CONSTRAINT `fk_AID_2` FOREIGN KEY (`Animal_id`) REFERENCES `animal_table` (`animal_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_EID` FOREIGN KEY (`email_id`) REFERENCES `login` (`email_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_pasturenumber` FOREIGN KEY (`pasturenumber`) REFERENCES `pasture` (`pasture_id`)
...
-- Dump completed on 2018-06-21 22:32:47
